...
for userY, rating in songData3.items():
    sim = similarity(songData3[userX],songData3[userY])
    euc = similarity.minkowski(sim, 2)
    if userY != userX:
        userDistances.append((userY, round(euc,1)))
